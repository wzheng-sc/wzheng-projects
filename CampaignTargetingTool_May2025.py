...
class CampaignTarget:
    ...
    is_snapchatplus_subscriber: bool,
        ...
        self.email_open_look_back_days = email_open_look_back_days
    ...
    def validation(self):
        ...
        if not self.has_email_open_constraints:
          ...
          print(f' • Email open constraints: {self.has_email_open_constraints}, {self.email_open_look_back_days}, Days ')
    ...
    def query_generator(self):
        ...
        email_open_table_condition = f"""AND email_open._TABLE_SUFFIX between FORMAT_DATE("%y%m%d",DATE_SUB(CURRENT_DATE('America/Los_Angeles'),INTERVAL 2 2 + {self.email_open_look_back_days} DAY)) AND FORMAT_DATE("%y%m%d",DATE_SUB(CURRENT_DATE('America/Los_Angeles'),INTERVAL 2 DAY))"""
