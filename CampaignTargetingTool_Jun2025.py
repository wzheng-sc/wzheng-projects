...
class CampaignTarget:
    ...
    def query_generator(self):
        ...
        email_open_table_condition = f"""AND email_open._TABLE_SUFFIX between FORMAT_DATE("%y%m%d",DATE_SUB(CURRENT_DATE('America/Los_Angeles'),INTERVAL 2 + {self.email_open_look_back_days_upper} DAY)) AND FORMAT_DATE("%y%m%d",DATE_SUB(CURRENT_DATE('America/Los_Angeles'),INTERVAL 2 + {self.email_open_look_back_days_lower} DAY))"""
        ...
        email_bounce_table_condition = f"""AND email_bounce._TABLE_SUFFIX between FORMAT_DATE("%y%m%d",DATE_SUB(CURRENT_DATE('America/Los_Angeles'),INTERVAL 2 + {self.email_bounce_look_back_days} DAY)) AND FORMAT_DATE("%y%m%d",DATE_SUB(CURRENT_DATE('America/Los_Angeles'),INTERVAL 2 DAY))"""
